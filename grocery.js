...
(function (root) {
  ...
  const RULES = [
    ...
    ['Condiments & Sauces', /\b(soy sauce|fish sauce|hoisin|oyster sauce|sriracha|ketchup|mustard|mayo|mayonnaise|worcestershire|vinegar|pesto|salsa|sauce|honey|syrup|sesame oil|balsamic|teriyaki|sherry|cooking wine|juice|dressing|vinaigrette)\b/],
    ['Pantry & Dry Goods', /\b(broth|stock|flour|breadcrumbs?|panko|sugar|rice|pasta|noodles?|rotini|spaghetti|oats|cornstarch|chia|seeds|granola|soup|baking)\b/],
    ...
    ['Produce', /\b(onions?|garlic|asparagus|potato(?:es)?|lemons?|limes?|ginger|rosemary|parsley|herbs?|thyme|basil|cilantro|tomato(?:es)?|lettuce|berr(y|ies)|pineapple|scallions?|green onion|avocados?|cabbage|carrots?|celery|spinach|kale|mushrooms?|cucumbers?|zucchini|apples?|bananas?|broccoli|cauliflower|shallots?|leeks?|corn|greens?|vegetables?|fruit|peppers?)\b/],
  ];
